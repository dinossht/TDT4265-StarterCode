...
def make_optimizer(cfg, model, lr=None):
    ...
    return torch.optim.Adam(model.parameters(), lr=lr/10.0, weight_decay=cfg.SOLVER.WEIGHT_DECAY)#, momentum=cfg.SOLVER.MOMENTUM, weight_decay=cfg.SOLVER.WEIGHT_DECAY)
